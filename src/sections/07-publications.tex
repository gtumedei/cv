...
\twocols{
  ...
  \heading{Evaluating Interaction Framings for Communicating Monumental Tree Heritage: A Within-Subject Study Exploiting Conversational Interfaces}\newline
  \subheading{Gianni Tumedei, Benedetta Bottari, Chiara Ceccarini, Catia Prandi}

  Submitted to ICMI 2026.
}

\twocols{
  2026
}{
  \heading{Representing Intangible Cultural Heritage as Living Artifacts: A First Digital Twin of a Culinary Recipe}\newline
  \subheading{Gianni Tumedei, Catia Prandi, Augusto Esteves}

  AVI 2026: 18th International Conference on Advanced Visual Interfaces.

  \link{https://doi.org/10.1145/3811427.3811468}
}
